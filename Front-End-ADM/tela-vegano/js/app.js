...
async function carregarCardapioADM() {
    ...
    try {
        ...
        //Filtrando apenas os produtos que são da categória vegano
        const apenasVegano = dadosProdutos.filter(produto => {
            ...
            return categoriaDoProduto === "VEGANO"
        })
        ...
        console.error(
            "Erro ao processar a tela de produtos veganos:",
            error
        )
