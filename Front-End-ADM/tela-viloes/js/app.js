...
async function carregarCardapioADM() {
    ...
    try {
        ...
        const apenasViloes = dadosProdutos.filter(produto => {
            ...
            return categoriaDoProduto === "VILÕES"
        })
        ...
        //Percorrendo apenas os produtos encontrados
        apenasViloes.forEach(produto => {
        ...
        console.error(
            "Erro ao processar a tela de categoria vilão:",
            error
        )
