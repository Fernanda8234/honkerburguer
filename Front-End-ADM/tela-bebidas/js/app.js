...
async function carregarCardapioADM() {
    ...
    try {
        ...
        //Filtrando apenas os produtos que são da categória bebidas
        const apenasBebidas = dadosProdutos.filter(produto => {
            ...
            return categoriaDoProduto === "BEBIDAS"
        })
        ...
        console.error(
            "Erro ao processar a tela de bebidas:",
            error
        )
