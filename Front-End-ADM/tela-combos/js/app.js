...
async function carregarCardapioADM() {
    ...
    try {
        ...
        //Filtrando apenas os produtos que são da categória combos
        const apenasCombos = dadosProdutos.filter(produto => {
            ...
            return categoriaDoProduto === "COMBOS"
        })
        ...
        console.error(
            "Erro ao processar a tela de combos:",
            error
        )
